 ...
 * @author xidon
 */
public class FrmCatalogoProducto2 extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FrmCatalogoProducto2.class.getName());

    /**
     * Creates new form FrmCatalogoProducto2
     */
    public FrmCatalogoProducto2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new FrmCatalogoProducto2().setVisible(true));
    }
